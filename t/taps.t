...
# try again, with taps out of order (to make sure that the new properly sorts taps, and that nbits works)
...
is( $seq->nbits, 3,                                                         'taps[1,3]->nbits                                           [taps out of order]');
